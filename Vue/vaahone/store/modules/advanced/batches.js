...
let ajax_url = base_url+"/backend/vaah/advanced/batches";
...
export default {
    ...
    actions:{
        ...
        updateView({ state, commit, dispatch, getters }, payload) {
            ...
            if(payload && payload.name && payload.name == 'batches.list')
            {
                list_view = 'large';
            ...
            if(payload.name == 'batches.create'
                || payload.name == 'batches.view'
                || payload.name == 'batches.edit')
            {
                list_view = 'medium';
            };
