            ...
            <Card>
                <template #header>
                    <div class="flex justify-content-between align-items-center">
                        <h5 class="white-space-nowrap font-semibold text-lg">{{root.assets.language_string.extend_themes.install_themes}}</h5>
                        <div class="p-inputgroup justify-content-end w-6">
                            <span class="p-input-icon-left">
                                <i class="pi pi-search" />
                                <InputText :placeholder="root.assets.language_string.extend_themes.install_placeholder_search"
                    ...
                    <div class="col-12 md:col-6" v-for="item in store.themes.data">
                        <Card>
                            ...
                            <template #content>
                                ...
                                <Tag class="mr-2 mb-2">{{root.assets.language_string.extend_themes.name}}:{{item.title}}</Tag>
                                <Tag class="mr-2 mb-2">{{root.assets.language_string.extend_themes.version}}: {{item.version}}</Tag>
                                <Tag class="mr-2 mb-2">{{root.assets.language_string.extend_themes.developed_by}}: {{item.author_name}}</Tag>
                            </template>
                            <template #footer v-if="store.hasPermission('can-install-theme')">
                                <Button icon="pi pi-check"
                                        ...
                                        :label="root.assets.language_string.extend_themes.installed_button">
                                </Button>
