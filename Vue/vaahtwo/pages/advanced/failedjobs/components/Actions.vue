    ...
    <div>
        ...
        <div :class="{'flex justify-content-between': store.isViewLarge()}" class="mt-2 mb-2">
            ...
            <div v-if="store.view === 'large' && root.assets.language_strings.general">
                ...
                <!--selected_menu-->
                <Button v-if="store.hasPermission('can-update-failed-jobs') || store.hasPermission('can-delete-failed-jobs')"
                        class="p-button-sm"
                ...
                <Button v-if="store.hasPermission('can-update-failed-jobs') || store.hasPermission('can-delete-failed-jobs')"
                        ...
                        data-testid="failedjobs-actions-bulk-menu"
                        aria-haspopup="true"
                    ...
                    <div class="col-12">
                        <div class="p-inputgroup">
                            ...
                            <Button @click="store.delayedSearch()"
                                    data-testid="failedjobs-actions-search-button"
                                    icon="pi pi-search"
                                    class="p-button-sm"
                            />
