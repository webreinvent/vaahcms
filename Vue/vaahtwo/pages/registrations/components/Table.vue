            ...
            >
                <template #body="prop">
                    <Tag severity="primary"
                         ...
                         :value="store.assets.language_string.table_gender_male"
                    />

                    <Tag severity="primary"
                         class="mr-2 p-tag-xs"
                         v-if="prop.data.gender && prop.data.gender=='f'"
                         :value="store.assets.language_string.table_gender_female"
                    />
                    <Tag severity="primary"
                         class="mr-2 p-tag-xs"
                         v-if="prop.data.gender && prop.data.gender=='o'"
                         :value="store.assets.language_string.table_gender_others"
                    />
                </template>
            </Column>
