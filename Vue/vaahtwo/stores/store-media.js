...
export const useMediaStore = defineStore({
    ...
    actions: {
        ...
        toForm()
        {
            this.item = vaah().clone(this.assets.empty_item);
            this.getFormMenu();
            this.$router.push({name: 'media.form'})
        },
        //---------------------------------------------------------------------
        toView(item)
        {
        ...
        {
            this.item = item;
            this.$router.push({name: 'media.form', params:{id:item.id}})
        },
        //---------------------------------------------------------------------
        isViewLarge()
        {
        ...
        //---------------------------------------------------------------------
        updateMediaToNewItem(media)
        {
            for(let index in media)
            {
                if(index == 'name' && this.item[index])
                {
                    continue;
                }
                this.item[index] = media[index];
            }
        },
        //---------------------------------------------------------------------
        toggle(event) {
