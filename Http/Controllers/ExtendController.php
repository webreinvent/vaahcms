...
class ExtendController extends Controller
{
    ...
    public static function sidebarMenu()
    {
        ...
        if (\Auth::user()->hasPermission('has-access-of-logs-section')) {
            ...
            $n++;
        } elseif (\Auth::user()->hasPermission('has-access-of-jobs-section')) {
            $list[$n] = [
            ...
            $n++;
        } elseif (\Auth::user()->hasPermission('has-access-of-failedjobs-section')) {
            $list[$n] = [
            ...
            $n++;
        } elseif (\Auth::user()->hasPermission('has-access-of-batches-section')) {
            $list[$n] = [
